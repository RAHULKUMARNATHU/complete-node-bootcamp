...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoia3VtYXJyYWh1bCIsImEiOiJjbG5nMzdpbXYwdHB6MmpwNDR4d2kwYTJnIn0.vMftBRxFMk07xgZfWKJ6Tg';
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', 'check your mail to reset the password!!');
            window.setTimeout(function () {
              location.assign('/');
            }, 1500);
          }
      ...
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 4:
          ...
          if ((res === null || res === void 0 || (_res$data = res.data) === null || _res$data === void 0 ? void 0 : _res$data.status) === 'success') {
            ...
            (0, _alert.showAlert)('error', 'Reset password failed. Please try again.');
          }
          _context2.next = 11;
          break;
        case 8:
...
var forgotPasswordForm = document.querySelector('.form--forgetPass');
var resetPasswordForm = document.querySelector('.form--resetPass');
  ...
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(e) {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          e.preventDefault();
          document.querySelector('.btn--green.btn--save-password').textContent = 'Updating..';
        ...
        case 7:
          ...
          document.querySelector('.btn--green.btn--save-password').textContent = 'Save Password';
        case 11:
        case "end":
          return _context2.stop();
      }
